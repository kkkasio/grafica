...
class ClienteJuridicoForm extends TPage
{
  ...
  function __construct()
  {
    ...
    $id_empresa = new TEntry('id_empresa');
    ...
    // add the fields
    $this->form->addFields([new TLabel('#(id cliente)')], [$id], [new TLabel('#(id empresa)')], [$id_empresa]);
    $this->form->addFields([new TLabel('Nome Fantasia')], [$nome], [new TLabel('Tipo')], [$tipo]);
    $this->form->addFields([new TLabel('Email')], [$email], [new TLabel('CNPJ')], [$cnpj]);
